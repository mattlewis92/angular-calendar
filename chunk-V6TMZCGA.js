import{Ib as o,Ka as l,Kb as i,Lb as g,Nb as m,Nc as f,Ob as C,Pb as p,Qc as S,Rc as E,Sc as T,Ua as h,Uc as V,Xb as c,_a as s,_b as y,pb as _,qb as t,rb as n,sb as u,yb as d}from"./chunk-QIMJXBNA.js";var B=(()=>{let v=class v{constructor(){this.locale="en",this.viewChange=new s,this.viewDateChange=new s,this.CalendarView=f}};v.\u0275fac=function(w){return new(w||v)},v.\u0275cmp=h({type:v,selectors:[["mwl-demo-utils-calendar-header"]],inputs:{view:"view",viewDate:"viewDate",locale:"locale"},outputs:{viewChange:"viewChange",viewDateChange:"viewDateChange"},decls:43,vars:16,consts:[[1,"row","text-center"],[1,"col-md-4"],[1,"btn-group"],["mwlCalendarPreviousView","",1,"btn","btn-primary",3,"viewDateChange","view","viewDate"],["mwlCalendarToday","",1,"btn","btn-outline-secondary",3,"viewDateChange","viewDate"],["mwlCalendarNextView","",1,"btn","btn-primary",3,"viewDateChange","view","viewDate"],[1,"btn","btn-primary",3,"click"]],template:function(w,e){w&1&&(i(0,`
    `),t(1,"div",0),i(2,`
      `),t(3,"div",1),i(4,`
        `),t(5,"div",2),i(6,`
