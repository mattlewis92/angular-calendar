...
`;var n=`<mwl-demo-utils-calendar-header [(view)]="view" [(viewDate)]="viewDate" />
...
`;var s=[{filename:"component.ts",contents:e},{filename:"template.html",contents:n}];export{s as sources};
