...
`;var t=`import { CalendarEventTitleFormatter, CalendarEvent } from 'angular-calendar';
...
`;var p=[{filename:"component.ts",contents:e},{filename:"custom-event-title-formatter.provider.ts",contents:t},{filename:"template.html",contents:a}];export{p as sources};
