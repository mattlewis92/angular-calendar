    ...
    provideRouter(
      [
        ...
        },
        {
          ...
          loadComponent: () =>
            import('./app/demo-modules/optional-event-end-dates/component').then(
              (c) => c.DemoComponent,
            ),
          data: {
        ...
        },
        {
          ...
          loadComponent: () =>
            import('./app/demo-modules/editable-deletable-events/component').then(
              (c) => c.DemoComponent,
            ),
          data: {
        ...
        },
        {
          ...
          loadComponent: () =>
            import('./app/demo-modules/navigating-between-views/component').then(
              (c) => c.DemoComponent,
            ),
          data: {
        ...
        },
        {
          path: 'i18n',
          loadComponent: () =>
            import('./app/demo-modules/i18n/component').then((c) => c.DemoComponent),
          data: {
        ...
        },
        {
          ...
          loadComponent: () =>
            import('./app/demo-modules/draggable-external-events/component').then(
              (c) => c.DemoComponent,
            ),
          data: {
        ...
        },
        {
          ...
          loadComponent: () =>
            import('./app/demo-modules/week-view-minute-precision/component').then(
              (c) => c.DemoComponent,
            ),
          data: {
        ...
        },
        {
          path: 'dayjs',
          loadComponent: () =>
            import('./app/demo-modules/dayjs/component').then((c) => c.DemoComponent),
          data: {
            label: 'Use dayjs',
          },
        },
        ...
        },
        {
          path: 'rtl',
          loadComponent: () =>
            import('./app/demo-modules/rtl/component').then((c) => c.DemoComponent),
          data: {
            label: 'RTL',
          },
        },
